...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.tax_info.claimed_by" => "This person will be claimed as a dependent by",
  "en.faa.tax_info.none" => "None",
  "en.faa.tax_info.person" => "Person",
  ...
  "en.faa.checklist.doesnt_need_insurance_header" => "For each person in your household who doesn’t need health insurance, you’ll need:",
  ...
  "en.faa.warning" => "Warning",
  "en.faa.other_ques.question_detail" => "Question Detail",
  ...
  "en.faa.this_person" => "this person",
  ...
  'en.faa.edit.sure_remove' => "Are you sure you want to remove everything you have entered for this %{income_type}?",
  "en.faa.edit.sure_remove_all" => 'Are you sure you want to remove all %{income_type}(s)?',
  'en.faa.edit.remove_warning' => 'This cannot be undone.',
  "en.faa.edit.confirm_deletion" => "Confirm Deletion",
  ...
  'en.faa.incomes.deduction' => 'deduction',
  'en.faa.incomes.benefit' => 'benefit',
  ...
  'en.faa.incomes.income_note' => "For %{income_kind} %{subject} currently receives, do not enter an end date into the “%{end_date_field_label}“ field. Only enter an end date if the %{income_kind} will end soon or has already ended.",
  ...
  "en.faa.incomes.from_employer" => "Does this person have income from an employer",
  ...
  "en.faa.incomes.from_self_employment" => "Does this person have self-employment income?",
  "en.faa.other_incomes.unemployment" => "Does this person receive unemployment compensation, or have they received it this year?",
  "en.faa.other_incomes.other_sources" => "Does this person have income from other sources?",
  ...
  "en.faa.medicaid_not_eligible_no_cubcare" => "Was this person found not eligible for MaineCare (Medicaid) within the last 90 days?",
  "en.faa.medicaid_cubcare_end_date_no_cubcare" => "When was this person denied MaineCare (Medicaid)?",
  "en.faa.change_eligibility_status_no_cubcare" => "Did this person have MaineCare (Medicaid) that will end soon or that recently ended because of a change in eligibility?",
  ...
  "en.faa.person_medicaid_last_day" => "What is the last day of this person’s MaineCare (Medicaid) coverage?",
  "en.faa.medicaid_chip_ineligible" => "Was this person found not eligible for MaineCare (Medicaid) based on their immigration status since %{year}",
  "en.faa.immigration_status_changed" => "Has this person’s immigration status changed since they were not found eligible for MaineCare (Medicaid)?",
  ...
  "en.faa.health_coverage.coverage_period_question" => "When did this coverage start? If you know when this coverage will end, please enter 'End Date'.",
  ...
  "en.faa.health_coverage.other_health_cov_type" => "Other Health Coverage Type",
  "en.faa.health_coverage.health_cov_type" => "Health Coverage Type",
  "en.faa.health_coverage.edit" => "Edit",
  "en.faa.health_coverage.delete" => "Delete",
  "en.faa.health_coverage.save" => "Save",
  "en.faa.health_coverage.type_modal_header" => "Health Care Types",
  "en.faa.health_coverage.esi.employer_name" => "Employer Name",
  "en.faa.health_coverage.esi.employer_address1" => "Employer Address Line 1",
  "en.faa.health_coverage.esi.employer_address2" => "Employer Address Line 2",
  "en.faa.health_coverage.esi.employer_city" => "City",
  "en.faa.health_coverage.esi.employer_state" => "State",
  "en.faa.health_coverage.esi.employer_zip" => "Zip Code",
  "en.faa.health_coverage.esi.employer_phone" => "Employer Phone",
  "en.faa.health_coverage.esi.employer_id" => "Employer ID Number (EIN)",
  "en.faa.health_coverage.esi.waiting_label" => "In a waiting period and eligible to enroll in the next 3 months",
  "en.faa.health_coverage.esi.waiting_question" => "Is the employee currently enrolled in a waiting period and eligible to enroll in the next 3 months?",
  "en.faa.health_coverage.esi.mvs_label" => "Employer offers a health plan that meets the minimum value standard",
  "en.faa.health_coverage.esi.mvs_question" => "Does this employer offer a health plan that meets the minimum value standard?",
  "en.faa.health_coverage.esi.covered" => "Covered",
  "en.faa.health_coverage.esi.covered_question" => "Who can be covered?",
  "en.faa.health_coverage.esi.self" => "Self",
  "en.faa.health_coverage.esi.self_and_spouse" => "Self & Spouse",
  "en.faa.health_coverage.esi.family" => "Family",
  "en.faa.health_coverage.esi.mvs_amount_question" => "How much the employee only would pay for the lowest cost minimum value standard plan?",
  "en.faa.health_coverage.esi.amount" => "Amount",
  "en.faa.health_coverage.esi.type_of_hra" => "Type of HRA",
  "en.faa.health_coverage.esi.individual_hra" => "Individual coverage HRA",
  "en.faa.health_coverage.esi.qse_hra" => "Qualified Small Employer HRA",
  "en.faa.health_coverage.esi.choose" => "Choose",
  "en.faa.health_coverage.esi.hra_max_question" => "What's the maximum self-only amount of reimbursement offered by this employer?",
  ...
  "en.faa.i_understand_evaluation_3" => "The Office for Family Independence will send you information about coverage and enrollment or contact you if they need more information.",
  "en.faa.i_understand_evaluation_1_no_cubcare" => "I understand that my application will be used to evaluate eligibility for MaineCare (Medicaid) ",
  "en.faa.i_understand_evaluation_2_no_cubcare" => "and will be sent to the Office for Family Independence for a final eligibility determination if anyone is likely to qualify for MaineCare.  ",
  ...
  "en.faa.review.personal.tribal_state" => "Tribe State",
  "en.faa.review.personal.tribal_name" => "Tribe Name",
  "en.faa.review.personal.tribe_codes" => "Tribe Codes",
  ...
  "en.faa.review.your_household.relationship_label" => "Relationship",
  "en.faa.review.your_household.is" => "is",
  "en.faa.review.your_household.of" => "of",
  "en.faa.review.your_household.relationship" => "%{related_name} is %{relationship} of",
  "en.faa.review.your_household.relationships_error" => "Some of the relationships you have listed are inconsistent. Review relationships and make sure each pair is correct.",
  ...
  "en.faa.mc_success_existing_no_cubcare" => "It looks like you may already be enrolled in MaineCare. If you need to update information like your income, address, or who is in your household, contact the Office for Family Independence at %{medicaid_agency_phone} to make these changes before completing a CoverME.gov application.",
  ...
  "en.faa.applications" => "Applications",
  ...
  "en.faa.applications.table.submission" => "Submission",
  "en.faa.applications.actions.update" => "Update Application",
  "en.faa.applications.actions.copy" => "Copy to New Application",
  "en.faa.applications.actions.view_eligibility" => "View Eligibility Determination",
  "en.faa.applications.actions.review" => "Review Application",
  "en.faa.applications.actions.full_application" => "Full Application",
  "en.faa.applications.actions.transfer_history" => "Transfer History",
  "en.faa.applications.detail" => "Application Detail",
  "en.faa.applications.detail.id" => "Application ID:",
  ...
  "en.faa.start_date_warning" => "<strong>Start Date: </strong>If this is income you currently have, you must enter the date you began receiving this income in the “%{start_date_field_label}“ field, or 1/1/%{current_year} (if the income started before this year). Do not enter a date in the future (for example, 1/1/%{next_year}) unless this is income that has not started but you expect to have in the future.",
  ...
  "en.faa.results.medicaid_or_chip_text" => "The people listed below appear to be eligible for %{medicaid_long_name}. %{medicaid_short_name} provides free and low-cost health insurance to Mainers who meet certain requirements. Your application has been sent to the %{state_medicaid_agency_long_name} (OFI) to make a final decision on whether they qualify for %{medicaid_short_name}. OFI will send you a letter and may ask you to provide documents needed to make an eligibility determination. If you have questions about %{medicaid_short_name} coverage, or haven't heard from OFI in 45 days, you may call OFI at %{medicaid_agency_phone} / TTY: %{medicaid_agency_phone_ttd}.",
  "en.faa.results.medicaid_or_chip_text2a" => "While this application is pending with OFI, the people listed below are not eligible to enroll with financial assistance on %{short_name}.",
  "en.faa.results.medicaid_or_chip_text2b" => "If they are not found eligible for %{medicaid_short_name}",
  "en.faa.results.medicaid_or_chip_text2c" => ", update this application right away in the ‘Health Coverage’ section to note they were not found eligible for %{medicaid_short_name} within the last 90 days.",
  "en.faa.results.medicaid_or_chip_text2d" => "If they are found eligible for %{medicaid_short_name}",
  "en.faa.results.medicaid_or_chip_text2e" => ", they should return to %{short_name} to end their coverage. If you need assistance updating your application, please call the %{short_name} Consumer Assistance Center at %{medicaid_agency_phone} / TTY: %{contact_center_tty_number}.",
  "en.faa.results.medicaid_or_chip_special_box" => '',
  "en.faa.results.non_magi_referral_heading" => "Special MaineCare Referral",
  "en.faa.results.non_magi_referral_text" => "The people listed below may qualify for %{medicaid_long_name} for reasons like age or disability. %{medicaid_short_name} provides free and low-cost health insurance to Mainers who meet certain requirements. The %{medicaid_or_chip_agency_long_name} (OFI) will make a final decision on whether those listed qualify for %{medicaid_short_name}. While awaiting a decision they can enroll with financial assistance through %{short_name}.",
  "en.faa.results.non_magi_referral_text2" => "If they are found eligible for %{medicaid_short_name}",
  "en.faa.results.non_magi_referral_text3" => ", they are no longer eligible for %{short_name} coverage with financial assistance. They should return to %{short_name} to end their coverage right away.",
  ...
  "en.faa.results.continue_text" => "Select “Continue to Next Step” to see if you are eligible to select a new plan or make changes to your current plan.",
